...
class FocusOntouchHandler(
    ...
    override fun onTouch(view: View, motionEvent: MotionEvent): Boolean {
        ...
        val y =
            (motionEvent.x / view.width.toFloat() * sensorArraySize!!.height().toFloat()).toInt()
        val x = (motionEvent.y / view.height.toFloat() * sensorArraySize.width().toFloat()).toInt()
        val halfTouchWidth =
            50 //(int)motionEvent.getTouchMajor(); //TODO: this doesn't represent actual touch size in pixel. Values range in [3, 10]...
